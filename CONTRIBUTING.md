...
***Ask not what ChessCtrl can do for you - ask what you can do for ChessCtrl***
...
2. Include additional information such as:
    ...
    * ChessCtrl Debug-Info containing:
...
1. Respect existing ChessCtrl coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
