...
// ChessDemo.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CChessDemoApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

// CChessDemoApp construction

CChessDemoApp::CChessDemoApp()
{
...
// The one and only CChessDemoApp object

CChessDemoApp theApp;

// CChessDemoApp initialization

BOOL CChessDemoApp::InitInstance()
{
